    ...
    if (jobType === 'product_texts' && result.products) {
      ...
      for (const product of result.products) {
        const createdProduct = await prisma.product.create({
          data: {
            ...
            description_html_sv: product.description_html_sv || null,
            seo_title_sv: product.seo_title_sv || null,
            seo_description_sv: product.seo_description_sv || null,
      ...
      return NextResponse.json({
        ...
        products: products.map(product => ({
          ...
          name_sv: product.name_sv,
          description_sv: product.description_sv,
          description_html_sv: product.description_html_sv,
          seo_title_sv: product.seo_title_sv,
          seo_description_sv: product.seo_description_sv,
          attributes: product.attributes,
          tone_hint: product.tone_hint,
